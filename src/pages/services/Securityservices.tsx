...
import enSecurityQuestions from '../data/text/en/security-questions.json';
import jaSecurityQuestions from '../data/text/ja/security-questions.json';
import zhSecurityQuestions from '../data/text/zh/security-questions.json';

// Create a language map
const languageMap = {
  en: enSecurityQuestions,
  ja: jaSecurityQuestions,
  zh: zhSecurityQuestions
};

interface SecurityQuestionsContent {
  title: string;
  subtitle: string;
  content: string[];
...
const Securityservices: React.FC = () => {
  ...
  const [pageContent, setPageContent] = useState<SecurityQuestionsContent | null>(null);
  ...
  const handleGenerateAnswer = () => {
    if (question.trim()) {
      fetchGroqResponse(
        ...
        '税務セキュリティに関する質問に答えてください:' : 
        'Answer this question about tax security:',
        question
      );
      setQuestion('');
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 
            ...
            style={{ color: colors.textPrimary }}
          >
            {currentLanguage.code === 'ja' ? '税務セキュリティに関するよくある質問' : 'Common Tax Security Questions'}
          </h2>
        ...
        >
          <div className="flex flex-col items-center">
            <h2 
              ...
              style={{ color: colors.textPrimary }}
            >
              {currentLanguage.code === 'ja' ? '税務セキュリティに関するご質問' : 'Ask About Tax Security'}
            </h2>
            <div className="w-full max-w-2xl">
              <div className="relative mb-4">
                ...
                <input
                  type="text"
                  placeholder={currentLanguage.code === 'ja' ? '税務セキュリティに関する質問を入力してください...' : 'Enter your tax security question...'}
                  value={question}

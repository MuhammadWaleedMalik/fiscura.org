...
import enCustomSoftwareDevelopment from '../data/text/en/custom-software-development.json';
import jaCustomSoftwareDevelopment from '../data/text/ja/custom-software-development.json';
import zhCustomSoftwareDevelopment from '../data/text/zh/custom-software-development.json';

// Create a language map
const languageMap = {
  en: enCustomSoftwareDevelopment,
  ja: jaCustomSoftwareDevelopment,
  zh: zhCustomSoftwareDevelopment
};

interface CustomSoftwareDevelopmentContent {
  title: string;
  subtitle: string;
  content: string[];
...
const CustomSoftwareDevelopment: React.FC = () => {
  ...
  const [pageContent, setPageContent] = useState<CustomSoftwareDevelopmentContent | null>(null);
  ...
  const handleGenerateAnswer = () => {
    if (question.trim()) {
      fetchGroqResponse(
        ...
        '税務ソフトウェアに関する質問に答えてください:' : 
        'Answer this question about custom tax software:',
        question
      );
      setQuestion('');
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 
            ...
            style={{ color: colors.textPrimary }}
          >
            {currentLanguage.code === 'ja' ? '税務ソフトウェアに関するよくある質問' : 'Common Tax Software Questions'}
          </h2>
        ...
        >
          <div className="flex flex-col items-center">
            <h2 
              ...
              style={{ color: colors.textPrimary }}
            >
              {currentLanguage.code === 'ja' ? '税務ソフトウェアに関するご質問' : 'Ask About Custom Tax Software'}
            </h2>
            <div className="w-full max-w-2xl">
              <div className="relative mb-4">
                ...
                <input
                  type="text"
                  placeholder={currentLanguage.code === 'ja' ? '税務ソフトウェアに関する質問を入力してください...' : 'Enter your tax software question...'}
                  value={question}

...
import enTechnologies from '../data/text/en/technologies.json';
import jaTechnologies from '../data/text/ja/technologies.json';
import zhTechnologies from '../data/text/zh/technologies.json';
...
const Technologysolutions: React.FC = () => {
  ...
  const [pageContent, setPageContent] = useState<TechnologiesContent | null>(null);
  ...
  const handleGenerateAnswer = () => {
    if (question.trim()) {
      fetchGroqResponse(
        ...
        '税務技術に関する質問に答えてください:' : 
        'Answer this question about tax technology:',
        question
      );
      setQuestion('');
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 
            ...
            style={{ color: colors.textPrimary }}
          >
            {currentLanguage.code === 'ja' ? '税務技術に関するよくある質問' : 'Common Tax Technology Questions'}
          </h2>
        ...
        >
          <div className="flex flex-col items-center">
            <h2 
              ...
              style={{ color: colors.textPrimary }}
            >
              {currentLanguage.code === 'ja' ? '税務技術に関するご質問' : 'Ask About Tax Technologies'}
            </h2>
            <div className="w-full max-w-2xl">
              <div className="relative mb-4">
                ...
                <input
                  type="text"
                  placeholder={currentLanguage.code === 'ja' ? '税務技術に関する質問を入力してください...' : 'Enter your tax technology question...'}
                  value={question}

...
//   const [pageContent, setPageContent] = useState<PrivacyContent | null>(null);
...
//       try {
//         // Try to load the current language content
//         const contentModule = await import(
//           `../data/text/${currentLanguage.code}/privacy.json`
//         );
//         setPageContent(contentModule.default);
//       } catch (err) {
//         console.error(`Failed to load ${currentLanguage.code} content:`, err);
//         try {
//           // Fallback to English if current language fails
//           const contentModule = await import('../data/text/en/privacy.json');
//           setPageContent(contentModule.default);
//         } catch (fallbackErr) {
